...
(function(){
    ...
    function addPagraphsToJumbotron() 
    {
            // step1. hook into the spot(element) on the page
    ...
    {
        //let contactForm = document.getElementsByTagName("form")[0]; ok

        //let contactForm = document.getElementById("contactForm"); not good

        //let contactForm = document.querySelector("form"); ok
    ...
    function Start()
    {
        ...
        let success = addPagraphsToJumbotron();
        ...
        {
            console.warn("content not added to jumbotron - does not exixt");
        }
        ...
        {
            console.warn("form not validated - does not exixt");
        }
